...
type RemotingClient interface {
	Receive(context.Context) *connect.BidiStreamForClient[remote.RemoteMessage, remote.RemoteMessage]
	ListProcesses(context.Context, *connect.Request[remote.ListProcessesRequest]) (*connect.Response[remote.ListProcessesResponse], error)
	GetProcessDiagnostics(context.Context, *connect.Request[remote.GetProcessDiagnosticsRequest]) (*connect.Response[remote.GetProcessDiagnosticsResponse], error)
}
...
func NewRemotingClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RemotingClient {
	...
	return &remotingClient{
		receive: connect.NewClient[remote.RemoteMessage, remote.RemoteMessage](
			httpClient,
			baseURL+RemotingReceiveProcedure,
			opts...,
		),
		listProcesses: connect.NewClient[remote.ListProcessesRequest, remote.ListProcessesResponse](
			httpClient,
			baseURL+RemotingListProcessesProcedure,
			opts...,
		),
		getProcessDiagnostics: connect.NewClient[remote.GetProcessDiagnosticsRequest, remote.GetProcessDiagnosticsResponse](
			httpClient,
...
type remotingClient struct {
	receive               *connect.Client[remote.RemoteMessage, remote.RemoteMessage]
	listProcesses         *connect.Client[remote.ListProcessesRequest, remote.ListProcessesResponse]
	getProcessDiagnostics *connect.Client[remote.GetProcessDiagnosticsRequest, remote.GetProcessDiagnosticsResponse]
}

// Receive calls remote.Remoting.Receive.
func (c *remotingClient) Receive(ctx context.Context) *connect.BidiStreamForClient[remote.RemoteMessage, remote.RemoteMessage] {
	return c.receive.CallBidiStream(ctx)
}

// ListProcesses calls remote.Remoting.ListProcesses.
func (c *remotingClient) ListProcesses(ctx context.Context, req *connect.Request[remote.ListProcessesRequest]) (*connect.Response[remote.ListProcessesResponse], error) {
	return c.listProcesses.CallUnary(ctx, req)
}

// GetProcessDiagnostics calls remote.Remoting.GetProcessDiagnostics.
func (c *remotingClient) GetProcessDiagnostics(ctx context.Context, req *connect.Request[remote.GetProcessDiagnosticsRequest]) (*connect.Response[remote.GetProcessDiagnosticsResponse], error) {
...
type RemotingHandler interface {
	Receive(context.Context, *connect.BidiStream[remote.RemoteMessage, remote.RemoteMessage]) error
	ListProcesses(context.Context, *connect.Request[remote.ListProcessesRequest]) (*connect.Response[remote.ListProcessesResponse], error)
	GetProcessDiagnostics(context.Context, *connect.Request[remote.GetProcessDiagnosticsRequest]) (*connect.Response[remote.GetProcessDiagnosticsResponse], error)
}
...
func (UnimplementedRemotingHandler) Receive(context.Context, *connect.BidiStream[remote.RemoteMessage, remote.RemoteMessage]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("remote.Remoting.Receive is not implemented"))
}

func (UnimplementedRemotingHandler) ListProcesses(context.Context, *connect.Request[remote.ListProcessesRequest]) (*connect.Response[remote.ListProcessesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("remote.Remoting.ListProcesses is not implemented"))
}

func (UnimplementedRemotingHandler) GetProcessDiagnostics(context.Context, *connect.Request[remote.GetProcessDiagnosticsRequest]) (*connect.Response[remote.GetProcessDiagnosticsResponse], error) {
